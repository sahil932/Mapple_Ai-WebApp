...
export const site = {
  ...
  // Set NEXT_PUBLIC_SITE_URL in Vercel when you connect a verified custom domain.
  // The live Vercel URL is the safe default so canonical and social links never point to a dead site.
  url: configuredUrl || "https://mapple-ai-web-app.vercel.app",
  description:
...
export const whyUs: { icon: string; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "Experience across lead capture, customer follow-up, reporting, and connected business workflows.",
  },
  {
    icon: "lifebuoy",
